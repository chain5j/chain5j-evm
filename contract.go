...
type Contract struct {
	...
	caller        protocol.ContractRef
	self          protocol.ContractRef
...
func NewContract(caller protocol.ContractRef, object protocol.ContractRef, value *big.Int, gas uint64) *Contract {
...
func (c *Contract) AsDelegate() protocol.Contract {
