...
//
//		statedb, _ := state.New(types.Hash{}, state.NewDatabase(rawdb.NewMemoryDatabase()))
...
//
//		vmctx := Context{
//			CanTransfer: func(StateDB, types.Address, *big.Int) bool { return true },
//			Transfer:    func(StateDB, types.Address, types.Address, *big.Int) {},
//		}
//		vmenv := NewEVM(vmctx, statedb, params.AllEthashProtocolChanges, Config{ExtraEips: []int{2200}})
//
//		_, gas, err := vmenv.Call(AccountRef(types.Address{}), address, nil, tt.gaspool, new(big.Int))
//		if err != tt.failure {
